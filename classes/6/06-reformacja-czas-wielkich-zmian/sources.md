# Źródła i prawa: Reformacja — czas wielkich zmian

## Zakres programowy
| Zakres | Źródło | Sposób użycia |
|---|---|---|
| aktywna podstawa dla klasy VI w 2026/2027 | [Rozporządzenie MEN z 28 czerwca 2024 r., Dz.U. 2024 poz. 996](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20240000996) | dział: „Złoty wiek” w Polsce na tle europejskim — renesans, reformacja i reforma Kościoła katolickiego |
| program / podręcznik | *Wczoraj i dziś*, klasa 6, dział o reformacji — **do potwierdzenia wydania przez nauczyciela** | poziom: przyczyny, Marcin Luter, główne nurty, skutki |

## Materiały ZPE wskazane przez nauczyciela

| Materiał | Zastosowanie w lekcji |
|---|---|
| [Reformacja w Niemczech](https://zpe.gov.pl/b/reformacja-w-niemczech/PRuOFwR5t) | wystąpienie Lutra, rozwój luteranizmu i pokój augsburski |
...
1. **Marcin Luter, „Disputation on the Power and Efficacy of Indulgences” (95 tez), 1517**, tezy 32 i 62. Tekst źródłowy w przekładzie angielskim Henry'ego Wace'a i C. A. Buchheima, [Project Gutenberg](https://www.gutenberg.org/ebooks/274). Na slajdzie zastosowano krótki polski przekład dydaktyczny; nie użyto grafiki.
...
- Lekcja pozostaje samowystarczalna offline; ZPE nie jest wymagane do jej przeprowadzenia.
