...
notes:
Pilnuj pytania „dla kogo, gdzie i kiedy?”. Nie upraszczaj skutków do listy plusów i minusów.
...
notes:
Wybierz neutralny przykład, np. nowa droga. Przenieś ideę perspektywy na temat historyczny.
...
notes:
Uczniowie mają wskazać różnicę lub pytanie, nie drobiazgowo analizować mapy.
...
notes:
Mapa pokazuje pracę kartografa, nie pełne doświadczenia ludzi żyjących w przedstawianych regionach.
...
notes:
Nie opieraj lekcji na czytaniu łacińskich podpisów. Uczniowie wskazują element, który rozpoznają.
...
notes:
Każdy punkt wymaga kontekstu z podręcznika. Nie uogólniaj doświadczeń całych grup.
...
Ułóż jeden łańcuch. Dopisz: „dla kogo?”.

notes:
Pary losują kartę skutku. Oceniaj uzasadnienie oraz wskazanie perspektywy.
...
notes:
Zbieraj pełne zdania z zaznaczoną perspektywą.
