# Plan lekcji: Polityka okupacyjna III Rzeszy i Zagłada Żydów
...
- Źródło wymagania: Dz.U. 2024 poz. 996, dział XXXII — II wojna światowa i okupacja.

## Wymaganie programowe
> „Charakteryzuje politykę niemiecką na terenach okupowanej Europy, ze szczególnym uwzględnieniem polityki wobec Żydów; przedstawia przykłady oporu i postaw społeczeństw wobec okupacji.”
...
- Nazistowskie pojęcie **Lebensraum** („przestrzeń życiowa”) oznaczało rzekome prawo Niemców do zdobywania ziem, zwłaszcza na Wschodzie. Łączyło podbój z planem wysiedleń, germanizacji, eksploatacji i podporządkowania ludności uznanej przez nazistów za „niższą”. Była to ideologia rasistowska, nie neutralne określenie polityki.
- W krajach Europy Zachodniej okupacja często opierała się na administracji, kontroli gospodarki, represjach i wykorzystywaniu miejscowych władz. W Europie Środkowej i Wschodniej terror był zwykle bardziej brutalny: masowe egzekucje, wysiedlenia, łapanki, praca przymusowa, głód i plany kolonizacyjne dotykały całych grup ludności. Różnica nie znaczy, że na Zachodzie nie było przemocy ani prześladowań.
- Na ziemiach polskich część terenów wcielono do III Rzeszy, a z pozostałej części utworzono Generalne Gubernatorstwo. Niemcy prowadzili grabież, wysiedlenia, germanizację, terror i zwalczali polskie elity. Ruch oporu obejmował m.in. Polskie Państwo Podziemne i Armię Krajową.
- Opór istniał też poza Polską: partyzanci Josipa Broza Tity walczyli w Jugosławii, ruch oporu działał w Grecji, a we Francji rozwijała się Résistance. Sposoby walki zależały od warunków: konspiracja, wywiad, sabotaż, pomoc więzionym, partyzantka i walka zbrojna.
- Naziści prześladowali Żydów już przed wojną: propaganda szerzyła nienawiść, ustawy norymberskie odbierały prawa, a pogrom „nocy kryształowej” w 1938 r. pokazał, że przemoc jest akceptowana przez państwo. Po rozpoczęciu wojny polityka została radykalnie zaostrzona.
- Żydów izolowano w **gettach**, nakazywano im nosić oznakowanie (w okupowanej Polsce najczęściej opaskę z gwiazdą Dawida; w innych miejscach często żółtą gwiazdę). Getta były zamkniętymi dzielnicami, w których panowały przeludnienie, głód i choroby. Nie były „dobrowolnymi dzielnicami”.
...
|---|---:|---|---|---|
| Wejście i mapa | 5 min | stawia pytanie; prowadzi odczyt mapy Europy | formułują hipotezę i lokalizują obszary | odpowiedź mapowa |
| Cele i modele okupacji | 8 min | wyjaśnia Lebensraum oraz porównanie regionów | wpisują dwa kontrasty | tabela w karcie |
| Polska i opór | 7 min | omawia mapę ziem polskich, zdjęcia i przykłady oporu | dopasowują przykłady | cztery poprawne pary |
| Polityka wobec Żydów | 12 min | prowadzi proces: przedwojenna nienawiść → getta → mordy → Wannsee → Zagłada | porządkują etapy | sekwencja w karcie |
| Obozy i postawy | 8 min | rozróżnia funkcje obozów; moderuje zadanie o postawach | klasyfikują przykłady i uzasadniają | odpowiedź pary |
| Synteza i bilet | 5 min | zbiera wniosek | odpowiadają samodzielnie | bilet wyjścia |

## Warianty prowadzenia
- **Rdzeń:** mapy, Lebensraum, porównanie regionów, etapy Zagłady, Auschwitz, Żegota i bilet.
- **Pomoc:** uczniowie dostają bank pojęć oraz zdania do dokończenia w zadaniach 2 i 4.
- **Rozszerzenie:** wyjaśnij, dlaczego jedno zdjęcie nie opisuje całej okupowanej Europy.
- **Punkt skrócenia:** skróć omówienie oporu do czterech przykładów; zachowaj porównanie, proces Zagłady i bilet.

## Dostosowania i ryzyka
- Nie pokazuj drastycznych obrazów ani nie zamieniaj tematu Zagłady w rywalizację. Używaj rzeczowego języka: „zamordowano”, „deportowano”, „prześladowano”.
- Podkreśl, że oznakowanie różniło się regionalnie; opaska w okupowanej Polsce nie jest jedyną formą oznakowania w Europie.
- Rozróżniaj działania jednostek, organizacji i władz od zbiorowej oceny całych narodów.
