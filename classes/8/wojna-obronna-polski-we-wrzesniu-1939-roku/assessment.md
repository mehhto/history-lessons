# Ocenianie: Wojna obronna Polski we wrześniu 1939 roku

## Kryteria sukcesu
Uczeń:
- umieszcza w kolejności daty 1 IX, 3 IX, 17 IX, 28 IX i 5 X 1939 r.;
- wyjaśnia co najmniej dwie przyczyny klęski Polski, odróżniając je od oceny odwagi obrońców;
...
- [ ] Nauczyciel potwierdza, że lokalna mapa i podpisy odpowiadają przyjętemu w klasie zakresowi wydarzeń.
- [ ] Nauczyciel sprawdza użycie fotografii wojennych pod kątem wieku uczniów i ustala zasady rozmowy o przemocy oraz losie cywilów.
- [ ] Nauczyciel wybiera regionalny przykład walki tylko po jego samodzielnym potwierdzeniu w wiarygodnym źródle.
